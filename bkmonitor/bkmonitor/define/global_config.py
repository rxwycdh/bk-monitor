...
STANDARD_CONFIGS = OrderedDict(
    [
        ...
        ("APM_BMW_WORKER_SUPPORT", slz.BooleanField(label=_("是否开启了 BMW 模块"), default=False)),
        ("APM_BMW_WORKER_SUPPORT_QUEUES", slz.ListField(label=_("BMW 模块 APM 任务处理队列"), default=[])),
